...
public final class ActivitySuccessBinding implements ViewBinding {
  ...
  private ActivitySuccessBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull ImageView logo, @NonNull TextView text) {
  ...
  public static ActivitySuccessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySuccessBinding((ConstraintLayout) rootView, button, logo, text);
    }
